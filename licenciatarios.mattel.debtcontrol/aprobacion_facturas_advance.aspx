<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="aprobacion_facturas_advance.aspx.cs" Inherits="licenciatarios.mattel.debtcontrol.aprobacion_facturas_advance" %>
  ...
  <form id="form1" runat="server">
    ...
    <div class="box-content-form">
      ...
      <div class="bx-lbl-btn" id="idBtnSave" runat="server" visible="false">
        <asp:Button ID="btnAprobar" CssClass="btnGuardar" runat="server" Text="Aprobar" OnClick="btnAprobar_Click" OnClientClick="this.disabled=true" UseSubmitBehavior="false" />
      </div>
    </div>
    <div class="box-pie">
