<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rechazo_factura_shortfall.aspx.cs" Inherits="licenciatarios.mattel.debtcontrol.rechazo_factura_shortfall" %>
  ...
  <form id="form1" runat="server">
    <div id="bx_msRechazo" runat="server">
      <div class="box-titulo">
        <asp:Label ID="lbltitulo" runat="server" Text="RECHAZO FACTURA SHORTFALL"></asp:Label>
      </div>
