...
{
  public partial class avance_minimo_garantizado : System.Web.UI.Page
  {
    Web oWeb = new Web();
    Usuario oUsuario;
    ...
    protected void cmbox_contrato_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      if (oConn.Open())
      {
        ...
        cmbox_periodo_minimo.Items.Add(new ListItem("<< Seleccione Periodo >>", "0"));
    ...
    protected void cmbox_periodo_minimo_SelectedIndexChanged(object sender, EventArgs e)
    {
    ...
    protected void getDataMinimiGaranty()
    {
      ...
      if (dtMinimoGarantizado != null)
      {
        if (dtMinimoGarantizado.Rows.Count > 0)
        {
          RadGrid oGridMinimo = new RadGrid();
          oGridMinimo.ID = "rdGridMinimo";
