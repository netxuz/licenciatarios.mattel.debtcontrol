<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="aprobar_facturas_short_fall_detalle.aspx.cs" Inherits="licenciatarios.mattel.debtcontrol.aprobar_facturas_short_fall_detalle" %>
...
<body>
  <form id="form1" runat="server">
    ...
    <div class="box-titulo">
      <asp:Label ID="lbltitulo" runat="server" Text="APROBACION DE FACTURA SHORT FALL"></asp:Label>
    </div>
    <div class="box-content-form">
      ...
      <div class="bx-lbl-btn" id="idBtnSave" runat="server">
        <asp:Button ID="btnAprobar" CssClass="btnGuardar" runat="server" Text="Aprobar" OnClick="btnAprobar_Click" />
        <asp:Button ID="btnCalcular" CssClass="btnGuardar" runat="server" Text="Calcular" OnClick="btnCalcular_Click" />
      </div>
