<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="avance-minimo-garantizado.aspx.cs" Inherits="licenciatarios.mattel.debtcontrol.avance_minimo_garantizado" %>
        ...
        <div class="box-content-form">
          <div class="bx-lbl-data">
            ...
            <div class="bx-lbl-filtros">
              ...
              <div class="bx-lbl-data">
                <asp:DropDownList ID="cmbox_periodo_minimo" CssClass="box-select" runat="server" OnSelectedIndexChanged="cmbox_periodo_minimo_SelectedIndexChanged" AutoPostBack="True">
                  <asp:ListItem Text="<< Selecciones Periodo >>" Value="0"></asp:ListItem>
                </asp:DropDownList>
              </div>
            </div>
          </div>
