<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reporte_ventas.aspx.cs" Inherits="licenciatarios.mattel.debtcontrol.reporte_ventas" %>
...
<body>
  <form id="form1" runat="server">
    ...
    <div class="box-titulo">
      <asp:Label ID="lbltitulo" runat="server" Text="REPORTE DE VENTA"></asp:Label>
    </div>
        ...
        <telerik:RadGrid ID="rdGridReporteVenta" runat="server"
          ...
          <MasterTableView AutoGenerateColumns="false" ShowHeader="true"
            ...
            <Columns>
              ...
              <telerik:GridBoundColumn DataField="precio_uni_venta_bruta" HeaderText="Precio Unit."
              ...
              <telerik:GridBoundColumn DataField="precio_uni_devolucion" HeaderText="Precio Unit."
